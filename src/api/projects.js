const projects = {
  ...
  9: {
    important: false,
    url: 'openlearning.kaplan.edu',
    screens: [
      '/static/img/projects/openlearning/openlearning-homepage.jpg',
      '/static/img/projects/openlearning/openlearning-courses.jpg',
      '/static/img/projects/openlearning/openlearning-instructors.jpg',
    ],
    pictureHome: '/static/img/projects/openlearning/thumb.jpg',
    name: 'Kaplan Open Learning',
    company: 'Kaplan University',
    project: 'Open College',
    roles: [
      'Ideation',
      'UX Design',
      'Front-end Developemnt',
